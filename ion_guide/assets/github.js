...
(function (globals) {
    ...
    gh.commit.forBranch = function (user, repo, branch, last_sha, callback, context) {
        try {

            jsonp("repos/" + user + "/" + repo + '/commits?per_page=100' + (typeof last_sha !== undefined && last_sha !== null && last_sha.length > 0 ? '&last_sha=' + last_sha : ''), callback, context);
